...
EXTERNAL_RESOURCE_USE_BY_DEFAULT = 'EXTERNAL_RESOURCE_USE_BY_DEFAULT', 'false'
...
DOCKER_REGISTRY = 'DOCKER_REGISTRY', None
...
JWT_CONFIG_PATH = 'JWT_CONFIG_PATH', None

MODEL_INSTANCE_SERVICE_ACCOUNT_NAME = 'model'
MODEL_PROPERTIES_CACHE_TTL = 10

K8S_API_RETRY_NUMBER_MAX_LIMIT = 'K8S_API_RETRY_NUMBER_MAX_LIMIT', 5
K8S_API_RETRY_DELAY_SEC = 'K8S_API_RETRY_DELAY_SEC', 3
